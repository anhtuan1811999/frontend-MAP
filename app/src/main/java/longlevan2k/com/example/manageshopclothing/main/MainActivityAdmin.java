...
public class MainActivityAdmin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (item.getItemId()){
                    ...
                    case R.id.nav_Turnover:
                        Intent intent = new Intent(MainActivityAdmin.this, Turnover.class);
                        startActivity(intent);
                        break;
                    case R.id.nav_AdminAddUser:
                        Intent intent1 = new Intent(MainActivityAdmin.this, SignUp.class);
        ...
        imgWarehouse.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MainActivityAdmin.this, Warehouse.class);
                startActivity(intent);
            }
        });
        ...
        imgAddCustomer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MainActivityAdmin.this, AddCustomer.class);
                startActivity(intent);
            }
        });
        ...
        imgAddBills.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MainActivityAdmin.this, AddBills.class);
                startActivity(intent);
            }
        });
        ...
        imgBills.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MainActivityAdmin.this, Bills.class);
                startActivity(intent);
            }
        });
        ...
        imgCustomer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MainActivityAdmin.this, Customer.class);
                startActivity(intent);
            }
        });
        ...
        imgProduct.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MainActivityAdmin.this, Product.class);
                startActivity(intent);
            }
        });
        ...
        imgProvider.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MainActivityAdmin.this, Provider.class);
                startActivity(intent);
            }
        });
    }
